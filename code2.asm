...
draw_screen_2
    ...
    ldy #3  ;address counter loop
    ldx #0
    lda #brick  ;platform brick character
.draw_platform_screen_2_loop
...
.draw_more_platform_screen_2_loop
    ...
    lda #brick  ;platform brick character
    dey
    beq .draw_more_platform_screen_2_loop
    bpl .draw_platform_screen_2_loop
    sta _SCREEN_ADDR+394
    sta _SCREEN_ADDR+414

    ldy #10  ;address counter loop
.draw_even_more_platform_screen_2_loop
    sta _SCREEN_ADDR+68,y
    sta _SCREEN_ADDR+483,y
    sta _SCREEN_ADDR+493,y
    dey
    bpl .draw_even_more_platform_screen_2_loop

    ldx #0  ;address counter loop
.draw_all_ladders_screen_2_loop
...
.get_screen_3_data_loop
    ...
    sta ladder_high
    lda #brick  ;platform brick character
.draw_platform_screen_3_loop
    sta (ladder_low),y
    dey
    bne .draw_platform_screen_3_loop
    inx
    cpx #24
    bne .get_screen_3_data_loop
...
.draw_more_platform_screen_3_loop
    lda #brick  ;platform brick character
    ...
    tay
    dex
    bne .draw_more_platform_screen_3_loop
...
draw_single_ladder
    ...
    sta (ladder_low),y  ;draw in first given address

.next_ladder_line_loop
    clc
    lda ladder_low
...
colour_in_platforms
    ldy #0  ;address counter
.colour_in_platforms_loop
    lda _SCREEN_ADDR,y
    cmp #brick  ;platform brick character
    bne .skip_colour_platform_bricks_red
    lda #red
    sta _COLOUR_SCREEN_ADDR,y

.skip_colour_platform_bricks_red
